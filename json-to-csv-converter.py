...
with open("raw-data/characters.json") as input_file1:
...
with open("raw-data/episodes.json") as input_file2:
...
with open('training-data/characters.csv', 'w') as output_file1:
        writer = csv.DictWriter(output_file1, training_set_part1[0].keys())
        writer.writeheader()
        writer.writerows(training_set_part1)

with open('training-data/episodes.csv', 'w') as output_file2:
